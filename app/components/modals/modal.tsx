    ...
    <>
      ...
      >
        <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/6 my-6 mx-auto h-full lg:h-auto md:h-auto">
          ...
          >
            <div
              className="relative w-full flex flex-col translate h-full lg:h-auto md:h-auto border-0 rounded-2xl shadow-xl
              bg-white outline-none focus:outline-none"
            >
              {/* Header */}
              <div className="relative flex justify-center items-center rounded-t p-6 border-b">
                <button
